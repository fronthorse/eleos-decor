...
const PRODUCT_KEYWORD_MAP = {
  ...
  frames: ["frame", "frames", "wall frame", "wall art", "artwork", "picture frame"],
  mirrors: ["mirror", "mirrors", "wall mirror"],
  rugs: ["rug", "rugs", "carpet", "floor mat"],
  lights: [
    "light",
    "lights",
    "lamp",
  ...
  diffusers: ["diffuser", "diffusers", "scent", "scents", "fragrance", "fragrances"],
...
const CATEGORY_RELEVANCE_RULES = {
  ...
  rugs: {
    include: ["rug", "rugs", "carpet", "floor mat"],
  },
  plants: {
    include: [
      "plant",
  ...
  frames: {
    include: ["frame", "frames", "wall frame", "wall art", "artwork", "picture frame"],
  },
  clocks: {
  ...
  diffusers: {
    include: ["diffuser", "diffusers", "fragrance", "scent"],
  },
  humidifiers: {
...
export function getCategoryNoMatchMessage(categoryLabel) {
  ...
  if (String(categoryLabel).toLowerCase().includes("table")) {
    return "I couldn't find table products currently listed, but you can browse the shop or message us on WhatsApp to confirm availability.";
  }

  if (String(categoryLabel).toLowerCase().includes("stool")) {
    return "I couldn't find side stool products currently listed, but you can browse the shop or message us on WhatsApp to confirm availability.";
  }

  return `We don't seem to have matching ${categoryLabel} available right now, but I can help you explore similar decor options or connect you on WhatsApp.`;
}
