...
export const ROOM_MATCHERS = [
  ...
  },
  {
    key: "dining area",
    label: "Dining area",
    terms: ["dining area", "dining room", "dining", "dinning area"],
  },
  {
    key: "tv console",
    label: "TV console",
...
const CATEGORY_MATCHERS = [
  ["dining sets", ["dining set", "dining sets", "dining table", "dining chair", "dinning set", "dinning table"]],
  ["clocks", ["clock", "clocks", "wall clock", "wall clocks"]],
  ["frames", ["frame", "frames", "wall art", "artwork"]],
  ["plants", ["plant", "plants", "artificial plant", "faux plant"]],
  ["flowers", ["flower", "flowers", "vase", "bouquet"]],
