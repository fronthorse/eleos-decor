...
const PRODUCT_BALANCED_CARD_IMAGE_TRANSFORM = {
  width: 640,
  height: 640,
  resize: "contain",
  quality: 76,
...
const PRODUCT_DETAIL_IMAGE_TRANSFORM = {
  width: 1100,
  height: 1100,
  resize: "contain",
  quality: 82,
...
export function getProductBalancedCardImageSrc(imageUrl) {
  return getSupabaseImageTransformUrl(
    imageUrl,
    PRODUCT_BALANCED_CARD_IMAGE_TRANSFORM
  );
}
...
export function getProductDetailImageSrc(imageUrl) {
  const transformedUrl = getSupabaseImageTransformUrl(
    imageUrl,
