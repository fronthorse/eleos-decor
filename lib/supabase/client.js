...
export function cleanupStaleSupabaseAuthStorage(activeStorageKey = "") {
  ...
  console.info("[supabase auth storage]", "cleanup", {
    activeStorageKey: expectedStorageKey,
    beforeAuthStorageKeys: before.authStorageKeys,
    removedStaleAuthStorageKeys: before.staleAuthStorageKeys,
    afterAuthStorageKeys: after.authStorageKeys,
    afterStoredAuthKeySummaries: after.storedAuthKeySummaries,
  });
